...
namespace Tcc_Senai.Controllers
{
    ...
    //    public async Task<IActionResult> Create([Bind("IdGerarCurso", "DataInicio", "DataFim", "Nome", "Nome")] GerarCurso gerar)
    //    {
    //        try
    //        {
    ...
    //    [HttpPost]
    //    [ValidateAntiForgeryToken]
    //    public async Task<IActionResult> Edit(long? id, [Bind("IdGerarCurso", "DataInicio", "DataFim", "Nome", "Nome")] GerarCurso gerar)
    //    {
